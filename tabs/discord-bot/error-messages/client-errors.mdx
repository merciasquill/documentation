...
This is a client-side error caused when an invalid value is provided as an input in a modal field; please try again and submit an appropriate value.
...
This is a client-side error caused when trying to enter a giveaway that has enabled additional integration restrictions that you do not meet. If enabled by the host, the specific details of the restriction will have been provided for you. This error may also be caused when trying to enter a giveaway using a flagged account.
...
## Unauthorized Giveaway Integration
...
This is a client-side error caused when trying to enter a giveaway that requires elevated access to your 3rd party accounts such as Xbox, Discord, or Twitch. Information about your connected accounts may be accessed by hosts to ensure a fair giveaway. Please authorize Mercia's Quill given your associated verification url and try again.
