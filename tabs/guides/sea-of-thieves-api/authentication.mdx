...
<Badge color="green">GET</Badge> <Badge color="blue">POST</Badge> <Badge color="yellow">PUT</Badge> <Badge color="red">DELETE</Badge>
...
<Badge color="blue">POST</Badge> <Badge color="yellow">PUT</Badge> <Badge color="red">DELETE</Badge>
...
<Warning>
  Mercia's Quill will never use this token or attempt to mimic a POST/PUT request using your credentials unless _explicitly_ prompted by you.
</Warning>
